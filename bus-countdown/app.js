...
/***/ function(module, exports) {
	...
	var _tjmw$bus_countdown$Prediction$Prediction = F4(
		function (a, b, c, d) {
			return {lineName: a, timeToStation: b, destinationName: c, vehicleId: d};
		});

	var _tjmw$bus_countdown$Model$Model = F2(
		function (a, b) {
			return {naptanId: a, predictions: b};
		});
	var _tjmw$bus_countdown$Model$emptyModel = A2(_tjmw$bus_countdown$Model$Model, '', _elm_lang$core$Dict$empty);
	...
	var _tjmw$bus_countdown$PredictionsFetcher$fetchInitialPredictions = function (naptanId) {
		var url = A2(
			_elm_lang$core$Basics_ops['++'],
			'https://api.tfl.gov.uk/StopPoint/',
			A2(_elm_lang$core$Basics_ops['++'], naptanId, '/Arrivals?mode=bus'));
		return A2(_evancz$elm_http$Http$get, _tjmw$bus_countdown$PredictionDecoder$predictionsDecoder, url);
	};
	...
	var _tjmw$bus_countdown$Main$drawPrediction = function (prediction) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(prediction.lineName)
						])),
					A2(
					_elm_lang$html$Html$td,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(prediction.destinationName)
						])),
					A2(
					_elm_lang$html$Html$td,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(prediction.vehicleId)
						]))
				]));
	};
	...
	var _tjmw$bus_countdown$Main$subscriptions = function (model) {
		return _tjmw$bus_countdown$Ports$predictions(_tjmw$bus_countdown$Main$Predictions);
	};
	...
	var _tjmw$bus_countdown$Main$update = F2(
		function (msg, model) {
			...
			switch (_p1.ctor) {
				...
				case 'FetchInitialPredictions':
					var url = A2(
						_elm_lang$core$Basics_ops['++'],
						'https://api.tfl.gov.uk/StopPoint/',
						A2(_elm_lang$core$Basics_ops['++'], model.naptanId, '/Arrivals?mode=bus'));
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A3(
							_elm_lang$core$Task$perform,
							_tjmw$bus_countdown$Main$InitialPredictionsError,
							_tjmw$bus_countdown$Main$InitialPredictionsSuccess,
							A2(
								_elm_lang$core$Task$mapError,
								_elm_lang$core$Basics$toString,
								A2(_evancz$elm_http$Http$get, _tjmw$bus_countdown$PredictionDecoder$initialPredictionsDecoder, url)))
					};
				case 'InitialPredictionsSuccess':
					return {
						ctor: '_Tuple2',
						_0: A2(_tjmw$bus_countdown$PredictionsUpdater$updatePredictions, model, _p1._0),
						_1: _tjmw$bus_countdown$Ports$registerForLivePredictions(model.naptanId)
					};
				case 'InitialPredictionsError':
					var _p2 = A2(_elm_lang$core$Debug$log, 'Predictions request failed', _p1._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				default:
					return {
						ctor: '_Tuple2',
						_0: A2(
							...
							model,
							_tjmw$bus_countdown$PredictionDecoder$decodePredictions(_p1._0)),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			}
		});
	var _tjmw$bus_countdown$Main$FetchInitialPredictions = {ctor: 'FetchInitialPredictions'};
	var _tjmw$bus_countdown$Main$UpdateNaptanId = function (a) {
		return {ctor: 'UpdateNaptanId', _0: a};
	};
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Events$onInput(_tjmw$bus_countdown$Main$UpdateNaptanId),
							_elm_lang$html$Html_Attributes$placeholder('Naptan ID')
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Events$onClick(_tjmw$bus_countdown$Main$FetchInitialPredictions)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
					...
					_elm_lang$core$Native_List.fromArray(
						[]),
					A2(_elm_lang$core$List$map, _tjmw$bus_countdown$Main$drawPrediction, sortedPredictions))
				]));
	};
	var _tjmw$bus_countdown$Main$main = {
	...
	var Elm = {};
	Elm['Main'] = Elm['Main'] || {};
	_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _tjmw$bus_countdown$Main$main === 'undefined' ? null : _tjmw$bus_countdown$Main$main);
